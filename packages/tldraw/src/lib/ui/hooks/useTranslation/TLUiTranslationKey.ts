...
export type TLUiTranslationKey =
	...
	| 'style-panel.choose-color'
	| 'style-panel.add-color'
	| 'style-panel.cancel'
	| 'style-panel.custom-color'
	| 'style-panel.custom-color-hue'
	| 'style-panel.custom-color-hex'
	| 'style-panel.custom-colors'
	| 'style-panel.hide-custom-color'
	| 'style-panel.custom-color-max'
	| 'tool-panel.title'
	| 'tool-panel.more'
