...
export const DEFAULT_TRANSLATION = {
	...
	'style-panel.choose-color': 'Choose a color',
	'style-panel.add-color': 'Add color',
	'style-panel.cancel': 'Cancel',
	'style-panel.custom-color': 'Custom color',
	'style-panel.custom-color-hue': 'Hue',
	'style-panel.custom-color-hex': 'Hex',
	'style-panel.custom-colors': 'Custom colors',
	'style-panel.hide-custom-color': 'Hide from palette',
	'style-panel.custom-color-max': '12 custom colors max; right-click to delete one',
